...
const Slider2 = () => {
  return (
    <div>
      <div className="bg-[#000000] h-[3rem] flex ">
        <h1 className=" ml-[8rem] px-[1rem] text-[2rem] text-black bg-white font-[Oswald]">
          Our Services
        </h1>
      </div>
        ...
        >
          <SwiperSlide>
            ...
            <div class="group relative rounded-[2rem] overflow-hidden transition-shadow ease hover:shadow-xl hover:shadow-black/30">
              <div class=" ">
                <img
                  class="  transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125"
                  src={img1}
                  alt=""
                />
              </div>
              ...
              <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                <div className="bg-[#00000091] backdrop-blur-[10px] m-2 w-[140%]">
                  {" "}
                  <h1 class="font-[Oswald] py-[1rem]  text-3xl  text-white">
                    Shooting Star
                  </h1>
                </div>
