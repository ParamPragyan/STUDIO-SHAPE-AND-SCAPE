      ...
      <footer>
        ...
        <div className="p-20 pl-[6rem] bg-black text-gray-500 outline-red-500 ">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-column-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 justify-center">

              <div className="align-middle  text-center">
                <h4 className="pb-4 font-bold text-xl">OPENING HOURS</h4>
                <table className="table-auto border-collapse flex justify-center  border-slate-400">
                  <tbody >
                    <tr>
              ...
              <div className="mb-5 text-center">
                ...
                <p className="pb-4 text-gray-500">
                  A123 Find city <br></br>sambalpur, PB 12345 <br></br> India{" "}
                </p>
              </div>
              <div className="mb-5 text-center">
                ...
                <div className=" text-xl text-white mb-2">
                  <a
                    href="https://wa.me/8328867593"
                    className="w-9 h-9 rounded-full bg-gray-500 hover:bg-gray-600 mx-1 inline-block pt-2 pl-2 "
                  >
                    <FaWhatsapp />
                  </a>
                  <a
                ...
                <div className="flex flex-col pt-5 text-center">
                  ...
                  <div className=" bg-black outline  outline-white text-white hover:bg-gray-700 cursor-pointer rounded-md">
                    Call 7876678887
                  </div>
                </div>
              </div>
              <div className="mb-5  usefullinks text-center">
